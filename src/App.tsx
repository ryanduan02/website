        ...
        <section className="resume" aria-label="Resume">
          ...
          <div className="resumeItem">
            ...
            <p>
              ...
              novel product capabilities. I decomposed backend services to
              improve extensibility and optimized the cache by adjusting cache
              admission policy to only retain entries with demonstrative use
              potential.
            </p>
          </div>
          ...
          <div className="resumeItem">
            ...
            <p>
              ...
              including calculus, linear algebra, and probability. Contributed
              to course material development, including a Python-based library
              for teaching computational probability.
            </p>
          </div>
